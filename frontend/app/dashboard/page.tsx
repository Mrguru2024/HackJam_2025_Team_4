...
export default function DashboardPage() {
  ...
  useEffect(() => {
    if (userInfo && (!userInfo.tags || userInfo.tags.length === 0)) {
      ...
      <div className="max-w-6xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between">
            <div>
              <h1 className="text-3xl font-bold text-title mb-2">
                {getPersonalizedGreeting(userInfo?.tags)}
                <br />
            ...
            <div className="mt-4 md:mt-0">
              <TitleBadge title={getTitleFromTags(userInfo?.tags)} />
            </div>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-surface-default rounded-2xl shadow-lg p-6 mb-6 border border-border-default">
          ...
          <XPBar
            ...
            targetXP={XP_THRESHOLD}
            message={getXPBarMessage(userInfo?.tags)}
          />
